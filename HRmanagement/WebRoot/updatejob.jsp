...
<form name="jobForm" method="post" action="modifyjob.do?action=updatejob&isstock=1" onSubmit="return jobValidate();" >
<div class="MainDiv">
		...
		<TR>
			<TD width="100%">
				...
				<tr>
					...
					<td><input name="age" type="text" class="input" value="<%=ob.getAge()%>"  ></td>
