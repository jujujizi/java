    ...
    <td class="CPanel">
		...
		<TR>
			<TD width="100%">
				...
				<tr>
					<td nowrap align="right" width="11%">姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</td>
					<td width="31%"><input name="name" type="text" class="input">
					<span class="red">*</span></td>
					<td width="14%"><div align="right">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</div></td>
					<td width="44%">
					<input name="sex" type="radio" value="1" checked>男
					<input name="sex" type="radio" value="0">女  
				</tr>
				<tr>
                					<td width="11%"><div align="right">体&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;检：</div></td>
					<td width="31%">
					<input name="health" type="radio" value="1" checked>通过
					<input name="health" type="radio" value="0">未通过  
					<td nowrap align="right" width="14%">年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;龄：</td>
				...
				<tr>
                	<td nowrap align="right">学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;历：</td>
					<td><input name="studyeffort" type="text" class="input">
					<span class="red">*</span></td>
					<td nowrap align="right">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：</td>
				...
				<tr>
					<td width="11%" nowrap align="right">详细经历：</td>
